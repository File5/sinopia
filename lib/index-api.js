...
module.exports = function(config, auth, storage) {
  ...
  app.delete('/:package/-rev{/*_rev}', can('publish'), function(req, res, next) {
  ...
  app.put('/:package/-/:filename{/*_filename}', can('publish'), media('application/octet-stream'), function(req, res, next) {
    var name = req.params.package
